...
-   `orcid_id`: The ORCID identifier, which links researchers to their publication records. For some individuals, this field may be blank if no ORCID profile was found.
-   `gsuser_id`: The Google Scholar user ID, which provides access to publication records and citation metrics. As with ORCID, some researchers may not have a Google Scholar profile, and this field will be blank for those cases.
