...
The bar chart shows the top 10 journals where Monash EBS staff publish the most. The "International Journal of Forecasting" is the top choice, with almost 200 publications, showing a strong focus on forecasting research. Next is the "Journal of Econometrics," indicating a key interest in econometric studies. Preprint platforms like "arXiv" and "SSRN" are also popular, showing that researchers often share their work openly. Other important journals include "Monash University" (likely representing internal publications) and more specialized ones like the "Journal of Computational and Graphical Statistics" and "Journal of Applied Econometrics." Overall, this chart shows that Monash EBS researchers are active in both forecasting and econometrics journals.
